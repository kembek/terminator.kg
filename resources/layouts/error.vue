...
<g id="Calque_1">
	<text id="XMLID_3_" transform="matrix(1.2187 0 0 1 13 75.6393)" class="st0 st1">{{statusCode[0]}}</text>
	<text id="XMLID_2_" transform="matrix(1.2187 0 0 1 72 75.6393)" class="st0 st1" v-if="statusCode[1] != 0">{{statusCode[1]}}</text>
	<text id="XMLID_4_" transform="matrix(1.2187 0 0 1 133.0003 73.6393)" class="st0 st1">{{statusCode[2]}}</text>
</g>
<g id="Calque_2" v-if="statusCode[1] == 0">
<g>
  ...
  <div class="message" v-if="error.statusCode == 404">
    Страница не найдена
  </div>
